 ...
 * - Toshimichi
 * 
 * This is sufficiently different between versions, so kept separately implemented per version.
...
public class FastBlockEditSession(
     ...
     * 
     * Chunk source api:
     * https://nms.screamingsandals.org/1.20.4/net/minecraft/server/level/ServerChunkCache.html
     */
